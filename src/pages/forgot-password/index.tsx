...
const RegisterPage = () => {
  ...
  const handleSubmit = async (values: FormValues, formikHelpers: FormikHelpers<FormValues>) => {
    ...
    try {
      ...
      if (res.success) {
        displayToast('success', 'Gửi yêu cầu thành công, vui lòng kiểm tra email để đặt lại mật khẩu')
    ...
    <Box className='content-center'>
      <Card sx={{ zIndex: 1 }}>
        <CardContent sx={{ padding: theme => `${theme.spacing(12, 9, 7)} !important` }}>
          ...
          <Box sx={{ mb: 6 }}>
            <Typography variant='h4' sx={{ fontWeight: 600, marginBottom: 1.5, textAlign: 'center' }}>
              Quên mật khẩu
            </Typography>
            <Typography variant='body2'>
              Vui lòng nhập vào email đã đăng ký sau đó kiểm tra hòm thư, chúng tối sẽ gửi cho bạn đường dẫn để giúp bạn
              đặt lại mật khẩu.
            </Typography>
          </Box>
          <Formik
